...
class ProductionCompanyTypeConverter {
    ...
    @TypeConverter
    fun toProductionCompanyList(productionCompanyListString:String):List<ProductionCompanyVO>?{
        val productionCompanyListType = object: TypeToken<List<ProductionCompanyVO>?>() {}.type
        return Gson().fromJson(productionCompanyListString,productionCompanyListType)
    }
}