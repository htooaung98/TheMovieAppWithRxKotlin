...
class ProductionCountryTypeConverter {
    ...
    @TypeConverter
    fun toProductionCountryList(productionCountryListString:String):List<ProductionCountryVO>?{
        val productionCountryListType = object: TypeToken<List<ProductionCountryVO>?>() {}.type
        return Gson().fromJson(productionCountryListString,productionCountryListType)
    }
}